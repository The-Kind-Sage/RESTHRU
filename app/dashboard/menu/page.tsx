...
const MOCK_CATEGORIES: Category[] = [
  { id: '1', name: 'Starters', emoji: '🥟', itemCount: 8, active: true, sortOrder: 1 },
  { id: '2', name: 'Main Course', emoji: '🍛', itemCount: 12, active: true, sortOrder: 2 },
  { id: '3', name: 'Drinks', emoji: '🥤', itemCount: 6, active: true, sortOrder: 3 },
  { id: '4', name: 'Desserts', emoji: '🍰', itemCount: 5, active: true, sortOrder: 4 },
  { id: '5', name: 'Specials', emoji: '⭐', itemCount: 4, active: true, sortOrder: 5 },
  { id: '6', name: 'Breakfast', emoji: '🍳', itemCount: 7, active: true, sortOrder: 6 },
];
...
const MOCK_ITEMS: MenuItem[] = [
  {
    ...
    nameNp: 'मोमो',
    category: '1',
    description: 'Steamed dumplings with meat or vegetables',
    price: 180,
    discountPrice: 150,
    foodType: 'non_veg',
    spiceLevel: 'mild',
  ...
  },
  {
    ...
    isNew: false,
    allergens: ['Gluten'],
    variants: [{ name: 'Single', price: 120 }],
    emoji: '📦',
  },
  {
    id: '3',
    ...
    nameNp: 'थकाली सेट',
    category: '2',
    description: 'Traditional Nepali set meal with dal, rice, vegetables and meat',
    price: 450,
    foodType: 'non_veg',
    spiceLevel: 'medium',
    prepTime: 30,
  ...
  },
  {
    ...
    nameNp: 'दाल भात',
    category: '2',
    description: 'Lentil curry with rice and seasonal vegetables',
    price: 280,
    foodType: 'veg',
    spiceLevel: 'mild',
    prepTime: 20,
  ...
  },
  {
    ...
    nameNp: 'मसला चिया',
    category: '3',
    description: 'Traditional spiced hot tea',
    price: 80,
    foodType: 'vegan',
    spiceLevel: 'none',
    prepTime: 5,
  ...
  },
  {
    ...
    variants: [
      { name: '2 pieces', price: 150 },
      { name: '4 pieces', price: 280 },
    ],
    emoji: '🍮',
  },
  {
    ...
    nameNp: 'माछा करी',
    category: '5',
    description: 'Fresh fish in aromatic spice gravy',
    price: 600,
    foodType: 'fish',
    spiceLevel: 'hot',
    prepTime: 35,
  ...
  },
  {
    ...
    variants: [{ name: 'Regular', price: 320 }],
    emoji: '🥞',
    outOfStock: true,
  },
  {
  ...
  },
  {
    id: '10',
    nameEn: 'Newari Pizza',
    nameNp: 'नेवारी पिज्जा',
    category: '5',
    description: 'Traditional Newari style pizza with local ingredients',
    price: 400,
    foodType: 'non_veg',
    spiceLevel: 'medium',
    prepTime: 25,
