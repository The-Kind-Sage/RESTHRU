          ...
          <TabsContent value="billing" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <Separator />
                <div className="space-y-3"><h3 className="font-semibold">Receipt Preview</h3><div className="mx-auto w-full max-w-sm space-y-1 rounded-lg border bg-muted/30 p-4 font-mono text-xs"><p className="text-center font-bold">{restaurant.name || 'Your Restaurant'}</p>{restaurant.address && <p className="text-center text-[10px]">{restaurant.address}</p>}<div className="my-2 border-b" /><p className="text-center text-[10px] italic text-muted-foreground">Items will appear here</p><div className="my-2 border-b" />{settings.bill_footer_message && <p className="text-center text-[10px]">{settings.bill_footer_message}</p>}</div></div>
