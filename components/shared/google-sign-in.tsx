...
export function GoogleSignInButton({
  ...
  useEffect(() => {
    if (gisReady && buttonRef.current && window.google) {
  ...
  return (
    <div className="w-full relative">
      <div ref={buttonRef} className="w-full [&>div]:w-full [&>div]:h-11" />
      {/* Overlay to hide Google's default styling issues */}
      <style>{`
        .w-full[data-google-signin] iframe {
          width: 100% !important;
